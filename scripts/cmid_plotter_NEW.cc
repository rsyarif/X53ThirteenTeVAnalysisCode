...
void cmid_plotter_NEW(){
  ...
  //open file
  TFile* f = new TFile("ChargeMisID_Data_Run2016_Electrons_MVATightRC.root");
  //outfile
  TFile* fout = new TFile("ChargeMisID_Data_Run2016_Electrons_MVATightRC_corrected.root","RECREATE");
  //get tree
  ...
  TH1F* h_hpt_32 = h_num_hpt->Clone("hpt_final");
  // h_hpt_32->Sumw2();
  h_hpt_32->Divide(h_den_hpt);

  TH1F* h_hpt_12 = h_weight_hpt->Clone();
  //h_hpt_12->Sumw2();
  ...
  c->Print("ChargeMisID_vAbsEta_hpt_corr.pdf");


  TH1F* h_hhpt_32 = h_num_hhpt->Clone("hhpt_final");
  //h_hhpt_32->Sumw2();
  h_hhpt_32->Divide(h_den_hhpt);

  TH1F* h_hhpt_12 = h_weight_hhpt->Clone();
  //h_hhpt_12->Sumw2();
  ...
  text1->Draw();
  text2->Draw();
  c->Print("ChargeMisID_vAbsEta_hhpt_corr.pdf");
  ...
  c->Print("ChargeMisID_vAbsEta_lpt.pdf");
  ...
  TH1F* h_hmpt_32 = h_num_hmpt->Clone("hmpt_final");
  //h_hmpt_32->Sumw2();                                                                                                                                                                                            
  h_hmpt_32->Divide(h_den_hmpt);
  
  TH1F* h_hmpt_12 = h_weight_hmpt->Clone();
  //h_hmpt_12->Sumw2();                                                                                                                                                                                            
  ...
  text1->Draw();
  text2->Draw();
  c->Print("ChargeMisID_vAbsEta_hmpt_corr.pdf");
  ...
  leg->Draw("same");
  c->Print("ChargeMisID_PairComparison_hhpt.pdf");
