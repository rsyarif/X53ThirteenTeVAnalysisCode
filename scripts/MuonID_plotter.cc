...
void MuonID_plotter(TString mcfile="TnP_MuonID_signal_mc_TightID_pt_eta.root", TString datafile = "TnP_MuonID_data_all_TightID_pt_abseta.root"){


  TFile* fmc = new TFile(mcfile);
  TFile* fdata = new TFile(datafile);

  TCanvas* cmc = (TCanvas*) fmc->Get("tpTree/TightID_pt_eta/fit_eff_plots/abseta_pt_PLOT");
