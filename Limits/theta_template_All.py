...
for proc in procs:
    ...
    #background MC
        ...
        model.add_lognormal_uncertainty('LepIDMu_mumu',math.log(1.02),proc,'mumu')
        #lepton ISO
        model.add_lognormal_uncertainty('LepISOEl_elel',math.log(1.02),proc,'elel')
        ...
        model.add_lognormal_uncertainty('LepISOMu_mumu',math.log(1.02),proc,'mumu')
        #lepton Trig
