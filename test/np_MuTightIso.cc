...
void np_MuTightIso(std::string htCut="1200",TString elID="MVA2016TightRC",TString muID = "CBTightMiniIsoTight"){
  ...
  TFile* fd1 = new TFile("Data_Mu"+muID+"_El"+elID+"_2016B-D.root");
  TTree* td1 = (TTree*) fd1->Get("tEvts_sZVeto");

  TFile* fd2 = new TFile("Data_Mu"+muID+"_El"+elID+"_2016E-H.root");
  TTree* td2 = (TTree*) fd2->Get("tEvts_sZVeto");
  ...
  std::string datacut = "((((((DilepMass>20) ) && ( (Channel!=0) ||(DilepMass<76.1 || DilepMass >106.1) ) )&& Lep1Pt > 40&& Lep2Pt > 30)&& nConst >= 5)&& cleanAK4HT > "+htCut+")";
  ...
  for(int i=-1; i<3;i++){
    ...
    float ndata1 = getNEvents(td1,i,datacut,noweight);
    ...
    float ndata2 = getNEvents(td2,i,datacut,noweight);
    std::cout<<"**************************"<<std::endl;
    std::cout<<"Channel: "<<i<<std::endl;
    std::cout<<"nt00 2016BD: "<<nt00_1<<std::endl;
    std::cout<<"nt01 2016BD: "<<nt01_1<<std::endl;
    std::cout<<"nt10 2016BD: "<<nt10_1<<std::endl;
    std::cout<<"nt11 2016BD: "<<nt11_1<<std::endl;// - BLINDED FOR NOW
    std::cout<<"nObs 2016BD: "<<ndata1<<std::endl;
    std::cout<<"nt00 2016EH: "<<nt00_2<<std::endl;
    std::cout<<"nt01 2016EH: "<<nt01_2<<std::endl;
    std::cout<<"nt10 2016EH: "<<nt10_2<<std::endl;
    std::cout<<"nt11 2016EH: "<<nt11_2<<std::endl;// - BLINDED FOR NOW
    std::cout<<"nObs 2016EH: "<<ndata2<<std::endl;
    ...
    if(i==0){
      ...
      h_tot = new TH1F("h_tot","",55,-5,50);
      h_nozero = new TH1F("h_nozero","",55,-5,50);
      h_tot_bd = new TH1F("h_tot","",55,-5,50);
      h_nozero_bd = new TH1F("h_nozero","",55,-5,50);
      h_tot_eh = new TH1F("h_tot","",55,-5,50);
      h_nozero_eh = new TH1F("h_nozero","",55,-5,50);
    }
    ...
    if(i==0){
      ...
      TH1F* hdummy_00 = (TH1F*) h_nt00_ee->Clone("hdummy_00");
      t2->Project("hdummy_00","cleanAK4HT",chan_nt00cut.c_str());
      h_nt00_ee->Add(hdummy_00);
      std::string chan_nt01cut = "("+nt01noHTcut+") && Channel==0";
      t->Project("h_nt01_ee","cleanAK4HT",chan_nt01cut.c_str());
      TH1F* hdummy_01 = (TH1F*) h_nt01_ee->Clone("hdummy_01");
      t2->Project("hdummy_01","cleanAK4HT",chan_nt01cut.c_str());
      h_nt01_ee->Add(hdummy_01);
	...
	float nff_1 = getnff( ntemp00_1,ntemp01_1,ntemp10_1,ntemp11_1,0);
	float nfp_1 = getnfp( ntemp00_1,ntemp01_1,ntemp10_1,ntemp11_1,0);
	float npf_1 = getnpf( ntemp00_1,ntemp01_1,ntemp10_1,ntemp11_1,0);
	//second experiment
	int ntemp00_2  = rand->Poisson(nt00_2);
	int ntemp01_2  = rand->Poisson(nt01_2);
	int ntemp10_2  = 0;
	int ntemp11_2  = rand->Poisson(nt11_2);
	float nff_2 = getnff( ntemp00_2,ntemp01_2,ntemp10_2,ntemp11_2,0);
	float nfp_2 = getnfp( ntemp00_2,ntemp01_2,ntemp10_2,ntemp11_2,0);
	float npf_2 = getnpf( ntemp00_2,ntemp01_2,ntemp10_2,ntemp11_2,0);
	...
	h_tot->Fill(nbkg);
      ...
      TH1F* hdummy_00 = (TH1F*) h_nt00_emu->Clone("hdummy_00");
      t2->Project("hdummy_00","cleanAK4HT",chan_nt00cut.c_str());
      h_nt00_emu->Add(hdummy_00);
      std::string chan_nt01cut = "("+nt01noHTcut+") && Channel==1";
      t->Project("h_nt01_emu","cleanAK4HT",chan_nt01cut.c_str());
      TH1F* hdummy_01 = (TH1F*) h_nt01_emu->Clone("hdummy_01");
      t2->Project("hdummy_01","cleanAK4HT",chan_nt01cut.c_str());
      h_nt01_emu->Add(hdummy_01);
      std::string chan_nt10cut = "("+nt10noHTcut+") && Channel==1";
      t->Project("h_nt10_emu","cleanAK4HT",chan_nt10cut.c_str());
      TH1F* hdummy_10 = (TH1F*) h_nt10_emu->Clone("hdummy_10");
      t2->Project("hdummy_10","cleanAK4HT",chan_nt10cut.c_str());
      h_nt10_emu->Add(hdummy_10);

      std::string chan_nt00cut_el = "("+nt00noHTcut+") && Channel==1 && Lep1Flavor==0";
      t->Project("hel_nt00_emu","cleanAK4HT",chan_nt00cut_el.c_str());
      TH1F* hdummy_00_el = (TH1F*) hel_nt00_emu->Clone("hdummy_00_el");
      t2->Project("hdummy_00_el","cleanAK4HT",chan_nt00cut_el.c_str());
      hel_nt00_emu->Add(hdummy_00_el);

      std::string chan_nt01cut_el = "("+nt01noHTcut+") && Channel==1 && Lep1Flavor==0";
      t->Project("hel_nt01_emu","cleanAK4HT",chan_nt01cut_el.c_str());
      TH1F* hdummy_01_el = (TH1F*) hel_nt01_emu->Clone("hdummy_01_el");
      t2->Project("hdummy_01_el","cleanAK4HT",chan_nt01cut_el.c_str());
      hel_nt01_emu->Add(hdummy_01_el);

      std::string chan_nt10cut_el = "("+nt10noHTcut+") && Channel==1 && Lep1Flavor==0";
      t->Project("hel_nt10_emu","cleanAK4HT",chan_nt10cut_el.c_str());
      TH1F* hdummy_10_el = (TH1F*) hel_nt10_emu->Clone("hdummy_10_el");
      t2->Project("hdummy_10_el","cleanAK4HT",chan_nt10cut_el.c_str());
      hel_nt10_emu->Add(hdummy_10_el);
      //leading muon
      std::string chan_nt00cut_mu = "("+nt00noHTcut+") && Channel==1 && Lep1Flavor==1";
      t->Project("hmu_nt00_emu","cleanAK4HT",chan_nt00cut_mu.c_str());
      TH1F* hdummy_00_mu = (TH1F*) hmu_nt00_emu->Clone("hdummy_00_mu");
      t2->Project("hdummy_00_mu","cleanAK4HT",chan_nt00cut_mu.c_str());
      hmu_nt00_emu->Add(hdummy_00_mu);

      std::string chan_nt01cut_mu = "("+nt01noHTcut+") && Channel==1 && Lep1Flavor==1";
      t->Project("hmu_nt01_emu","cleanAK4HT",chan_nt01cut_mu.c_str());
      TH1F* hdummy_01_mu = (TH1F*) hmu_nt01_emu->Clone("hdummy_01_mu");
      t2->Project("hdummy_01_mu","cleanAK4HT",chan_nt01cut_mu.c_str());
      hmu_nt01_emu->Add(hdummy_01_mu);

      std::string chan_nt10cut_mu = "("+nt10noHTcut+") && Channel==1 && Lep1Flavor==1";
      t->Project("hmu_nt10_emu","cleanAK4HT",chan_nt10cut_mu.c_str());
      TH1F* hdummy_10_mu = (TH1F*) hmu_nt10_emu->Clone("hdummy_10_mu");
      t2->Project("hdummy_10_mu","cleanAK4HT",chan_nt10cut_mu.c_str());
      hmu_nt10_emu->Add(hdummy_10_mu);
	...
	h_tot->Fill(nbkg);
      ...
      TH1F* hdummy_00 = (TH1F*) h_nt00_mumu->Clone("hdummy_00");
      t2->Project("hdummy_00","cleanAK4HT",chan_nt00cut.c_str());
      h_nt00_mumu->Add(hdummy_00);
      std::string chan_nt10cut = "("+nt10noHTcut+") && Channel==1";
      t->Project("h_nt10_mumu","cleanAK4HT",chan_nt10cut.c_str());
      TH1F* hdummy_10 = (TH1F*) h_nt10_mumu->Clone("hdummy_10");
      t2->Project("hdummy_10","cleanAK4HT",chan_nt10cut.c_str());
      h_nt10_mumu->Add(hdummy_10);
	...
	int ntemp10_1  = rand->Poisson(nt10_1);
	int ntemp11_1  = rand->Poisson(nt11_1);
	float nff_1 = getnff( ntemp00_1,ntemp01_1,ntemp10_1,ntemp11_1,2);
	float nfp_1 = getnfp( ntemp00_1,ntemp01_1,ntemp10_1,ntemp11_1,2);
	float npf_1 = getnpf( ntemp00_1,ntemp01_1,ntemp10_1,ntemp11_1,2);
	//second experiment
	int ntemp00_2  = rand->Poisson(nt00_2);
	int ntemp01_2  = 0;
	int ntemp10_2  = rand->Poisson(nt10_2);
	int ntemp11_2  = rand->Poisson(nt11_2);
	float nff_2 = getnff( ntemp00_2,ntemp01_2,ntemp10_2,ntemp11_2,2);
	float nfp_2 = getnfp( ntemp00_2,ntemp01_2,ntemp10_2,ntemp11_2,2);
	float npf_2 = getnpf( ntemp00_2,ntemp01_2,ntemp10_2,ntemp11_2,2);
