...
int main(int argc, char* argv[]){
  ...
  if(argv1.find("Data")!=std::string::npos) {
    if(MuonChannel) filenames.push_back("/eos/uscms/store/user/lpctlbsm/clint/FakeRate/25ns/July2/ljmet_trees/ljmet_FakeRate_Mu.root");
    else if(!MuonChannel) filenames.push_back("/eos/uscms/store/user/lpctlbsm/clint/FakeRate/25ns/July2/ljmet_trees/ljmet_FakeRate_El.root");
  }
  else{
